...
<div id="comments" class="comments-area">
	...
	<?php 
		 ...
		 $comments_args = array(
		         ...
		         'comment_field' => '<p class="comment-form-comment clearfix"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label><textarea id="comment" name="comment" aria-required="true" placeholder="Tell us what you think."></textarea></p>',
		         'fields' => $fields
		 );
